...
contract CardToken is ERC1155, ERC1155Holder, Ownable {
    ...
    */
    ...
    function buySingleToken(uint256 id) public payable {
        uint256 fromBalance = super._balances[id][address(this)];
        ...
        // Transfer
        super._balances[id][address(this)] = fromBalance - 1;
        super._balances[id][msg.sender] += 1;
    ...
    */
    ...
    function buyPack() public payable {
        ...
        for (uint256 i = 0; i < 4; i++) {
            ...
            uint256 fromBalance = super._balances[selectedId][address(this)];
            require(fromBalance >= 1, "Insufficient balance for transfer");
            if (tokensForPackSaleBalances[selectedId] == 0) {
                _tokensForPackSale.remove(selectedId);
            }
            // Transfer
            super._balances[selectedId][address(this)] = fromBalance - 1;
            super._balances[selectedId][msg.sender] += 1;
