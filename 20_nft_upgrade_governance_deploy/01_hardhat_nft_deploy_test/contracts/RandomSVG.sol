...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    event requestedRandomSVG2(bytes32 indexed requestId, uint256 indexed tokenId); 
    ...
    function create() public returns (bytes32 requestId) {
        ...
        // get the tokenURI and mint the NFT token.
        // keccak(block.difficulty)
        ...
        emit requestedRandomSVG2(requestId, tokenId);
    }
